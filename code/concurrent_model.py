...
class ConcurrentModel(ABC):
    ...
    @abstractmethod
    def start(self, producer: Producer, consumer: Consumer , args:Args) -> list[ChunkInfo]:
...
class MultiProcessingModel(ConcurrentModel):
    ...
    def start(self, producer: Producer, consumer: Consumer , args:Args) -> list[ChunkInfo]:
        ...
        return  merge_chunks_info(producer.reading_info_queue, consumer.filtering_info_queue)
